...
void clientRPC(RPCParameters *rpcParameters)
{
	...
	BitStream b(rpcParameters->input, (rpcParameters->numberOfBitsOfData-1)/8+1, false);
	char name[200];
...
int main(void)
{
	...
	if (rakClient->Connect("127.0.0.1", 2000, 0, 0)==false)
	{
